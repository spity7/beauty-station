...
| Live catalog strips | Production home/shop category sections use `loadPublishedCategories()` (`client/lib/catalog.ts`) with static fallback; brands use `fetchStorefrontBrands()` when wired                                                                                                                                                                                                                                                                                                                                   |
